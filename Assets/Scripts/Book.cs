...
public class Book : MonoBehaviour {
    ...
    public List<Sprite> activeBookPages;
    ...
    public int TotalPageCount {
        get { return activeBookPages.Count; }
    }
    ...
    public void AssignHiddenObjects(List<Sprite> bookPages)
    {
        activeBookPages = new List<Sprite>();
        currentPage = 0;
        for (int i = 0; i < bookPages.Count; i++)
        {
            activeBookPages.Add(bookPages[i]);
        } 
    ...
    {
        if (currentPage >= activeBookPages.Count) return;
        pageDragging = true;
        mode = FlipMode.RightToLeft;
        f = point;
        ...
        Left.sprite = (currentPage < activeBookPages.Count) ? activeBookPages[currentPage] : background;
        Left.transform.SetAsFirstSibling();
        
        Right.gameObject.SetActive(true);
        Right.transform.position = RightNext.transform.position;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.sprite = (currentPage < activeBookPages.Count - 1) ? activeBookPages[currentPage + 1] : background;

        RightNext.sprite = (currentPage < activeBookPages.Count - 2) ? activeBookPages[currentPage + 2] : background;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Right.sprite = activeBookPages[currentPage - 1];
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.transform.SetAsFirstSibling();
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.sprite = (currentPage >= 2) ? activeBookPages[currentPage - 2] : background;

        LeftNext.sprite = (currentPage >= 3) ? activeBookPages[currentPage - 3] : background;
    ...
    void UpdateSprites()
    {
        LeftNext.sprite= (currentPage > 0 && currentPage <= activeBookPages.Count) ? activeBookPages[currentPage-1] : background;
        RightNext.sprite=(currentPage>=0 &&currentPage< activeBookPages.Count) ? activeBookPages[currentPage] : background;
    }
